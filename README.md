...
```
cd existing_repo
git remote add origin https://gitlab.com/tomal2514/kampus-library-rest.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tomal2514/kampus-library-rest/-/settings/integrations)
